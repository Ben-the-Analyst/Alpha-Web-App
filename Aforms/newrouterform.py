...
#         "Territory*", options=TERRITORIES, key="territory_selectbox"
#     )
#     month = st.selectbox("Month*", options=MONTHS, key="month_selectbox")
#     week = st.selectbox("Week*", options=WEEKS, key="week_selectbox")
#     day = st.selectbox("Day*", options=DAYS, key="day_selectbox")
#     date = st.date_input(label="Route Plan Date")
#     selected_name = st.selectbox("Your Name*", options=AGENTNAMES, key="name_selectbox")
...
#         "Region*", options=filtered_regions, key="region_selectbox"
#     )
